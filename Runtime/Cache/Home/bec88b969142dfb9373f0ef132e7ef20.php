  ...
  <div class="page-news">
   <div id="shownews">
    ...
    <div class="text editor">
	 <ul class="showjobList clearfix">
	 	
	  <li class="frist"><b style="font-size: 20px;"><?php echo ($job['title']); ?></b></li>
	  <li class="frist"><span>工作地点</span> <?php echo ($job['location']); ?></li>
	  <li><div class="f_l"><span>时间</span> <?php echo (date("y/m/d",$job['dateline'])); ?></div><div class="f_l"><span style="border-left:1px solid #ccc ;">人数</span> <?php echo ($job['num']); ?></div></li>
      <li><span>工资</span> <?php echo ($job['deal']); ?></li>

	 </ul>
	 <div class="lhms"><b class="jobDescription">工作描述</b>
	 <span><?php echo ($job['content']); ?></span>
	</div>
	 <div class="lh616" style="text-align:center;"><a href="<?php echo U('/Job/doJob',array('id'=>$job['id']));?>" style="color:#FF0000">在线应聘 →</a></div>
	</div>
    <div class="clear"></div>
    <script>
    $(function(){
    	
    		$(".showjobList li:odd").css({background: "#f7f7f7"})
    	})
    </script>
   </div>
  </div>
