...
<div data-role="page" id="index" class="main_box">
  ...
  <article class="News-detail">
    ...
    <div class="pageControlBar">
	   ...
	   <section class='active pagePrev'><a href='<?php if(!empty($pre)): echo U('Wap/product/show',array('sid'=>$pre['sort'],'id'=>$pre['id'])); endif; ?>'>
        <p class='p1'> 上一条 </p>
      ...
      <section class='active pageNext'><a href='<?php if(!empty($next)): echo U('Wap/product/show',array('sid'=>$next['sort'],'id'=>$next['id'])); endif; ?>'>
        <p class='p1'> 下一条 </p>
		<?php if(!empty($next)): ?><p class='p2'><?php echo ($next['title']); ?></p><?php else: ?><p class='p2'>没有了</p><?php endif; ?>
        <p class='arrow'></p>
        </a>
	</section>
