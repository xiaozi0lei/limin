...
<div class="lanmu">
 ...
 <div class="listnr"><div class="ddsmoothmenu-v" id="LeftMenu">
   ...
   <h2 class="heatop"><span></span><b><?php echo ($name); ?></b><span></span></h2>
<!--   <ul class="lher">
		   <?php $_list=getSorts(532,0,0);if(!empty($_list)){foreach($_list as $k=>$sort){?><li><a href="<?php echo ($sort["url"]); ?>"><?php echo ($sort["name"]); ?></a></li><?php }}?>
		</ul>-->
   <div class="page-products">
   <div class="flwz"><?php echo ($sort_desc); ?></div>
   
     <ul class="clearfix proNav" id="ShowImages" >
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($item["url"]); ?>" title="<?php echo ($item["title"]); ?>"><span><b class="lhsp"></b><img src="<?php echo ($site_url); ?>/<?php echo ($item["pic"]); ?>" alt="<?php echo ($item["title"]); ?>" /></span><label><?php echo ($item["title"]); ?></label></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
