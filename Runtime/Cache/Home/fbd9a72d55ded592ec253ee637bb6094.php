...
<div id="page_main" class="clearfix">
 <div class="container">
   ...
   <div class="page-news lhd615">
    <ul class="jobList clearfix">
     <li class="jobtime"><span>日期</span></li>
     <li class="jobPosition"><span>职位</span></li>
     <li class="jobtime hidden-phone"><span>工资</span></li>
     <li class="jobtime hidden-phone"><span>人数</span></li>
     <li class="jobtime"><span>应聘</span></li>
     </ul>
     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><ul class="jobList clearfix">
      <li class="jobtime"><?php echo (date("y/m/d",$li['dateline'])); ?></li>
      <li class="jobPosition"><a href="<?php echo ($li["url"]); ?>" title="<?php echo ($li["title"]); ?>"><?php echo ($li["title"]); ?></a></li>
      <li class="jobtime hidden-phone"><?php echo ($li["deal"]); ?></li>
      <li class="jobtime hidden-phone"><?php echo ($li["num"]); ?></li>
      <li class="jobtime"><a href="<?php echo U('/Job/doJob',array('id'=>$li['id']));?>">在线应聘</a></li>
         </ul><?php endforeach; endif; else: echo "" ;endif; ?>
 
    <script>
    	$(function(){
    		$(".lhd615 ul:odd").css({background: "#f7f7f7"})
    	})
    </script>
    <div class=""></div>
