...
<div>
      <div class="news_list" id="news-list"> 
        ...
        <ul id="listtable" class="news-lists">
		 ...
		 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><li class="ali"> <a class="ui-link" target="_blank" href="<?php echo U('/Wap/article/show/id/'.$l['id'].'/sid/'.$l['sort']);?>">
            <h3> <cite></cite><span style="color:"><?php echo ($l["title"]); ?></span></h3>
            <p><?php echo (date("y/m/d",$l['dateline'])); ?></p>
