 ...
 <div class="container">
   ...
   <div class="page-news">
     ...
     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><li style="overflow:hidden;">
       <span class="dateTitle fl"><a href="<?php echo ($li["url"]); ?>" title="<?php echo ($li["title"]); ?>"><?php echo ($li["title"]); ?></a></span>
       <span class="dateTime fr">[<?php echo (date("y/m/d",$li['dateline'])); ?>]</span>
       <span class="downloadtimes fr"><a href="<?php echo U('/Download/doDownload',array('id'=>$li['id']));?>" title="<?php echo ($li["title"]); ?>">下载</a></span>
