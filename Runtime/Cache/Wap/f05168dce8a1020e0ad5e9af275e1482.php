...
<div id="page_main" class="clearfix">
    <div class="page-right">
      ...
      </span> <span class="BigclassName"><?php echo ($current_sort['name']); ?></span> 
      ...
      <ul class="productListCont clear">
        ...
        <div class='imgWrap'>
        <a href="<?php echo U('Picture/show',array('id'=>$item['id'],'sid'=>$item['sort']));?>" title="<?php echo ($item["title"]); ?>"><img  src="<?php echo ($site_url); ?>/<?php echo ($item["pic"]); ?>" width="<?php echo ($wap_picthumb_width); ?>" height="<?php echo ($wap_picthumb_height); ?>" alt="<?php echo ($item["title"]); ?>" /></a></div>
        
        
         <div class='infoWrap'> <h3 class='productTitle'>
        <span><?php echo ($item["title"]); ?></span></a></h3></div>
