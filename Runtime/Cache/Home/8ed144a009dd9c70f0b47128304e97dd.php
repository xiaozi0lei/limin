...
<div id="page_main" class="clearfix">
 <div class="container">
  ...
  <div class="page-news">
   <div id="shownews">
    <h1 class="title">在线应聘</h1>
    <div class="page-guestbook">
      <form method="post" name="guestbook" id="guestbook" action="<?php echo U('Job/submitJob');?>" enctype="multipart/form-data" >
      <dl class="clearfix">
        <dt><b>职位名称：</b><span><?php echo ($title); ?></span></dt>
      	 
	    <?php if(is_array($field)): $i = 0; $__LIST__ = $field;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i;?><dt><b><?php echo ($field["title"]); ?>：</b><span><?php echo ($field["html"]); ?> <?php if($field['required']==1): ?><i>*</i><?php endif; ?></span></dt><?php endforeach; endif; else: echo "" ;endif; ?>
     </dl>
	  <input type="hidden" name="jid" value="<?php echo ($id); ?>" />
	  <p style=" text-align: center;"><input type="submit"  class="submit" name="submit" id="submit" style="display: inline-block; width: 110px;" value="提交"><input type="reset" class="lh615" name="button" id="button" value="重置"  style="display: inline-block; width: 110px;"/>
      </p>
      </form>
    </div>
	<div class="clear"></div>
