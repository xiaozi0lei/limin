...
<div id="page_main" class="clearfix">
    <div class="page-right">
      ...
      <ul class="clearfix">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Picture/show',array('id'=>$list['id'],'sid'=>$list['sort']));?>" title="<?php echo ($list["title"]); ?>"><img  src="<?php echo ($site_url); ?>/<?php echo ($list["pic"]); ?>" width="200" height="150" /><span><?php echo ($list["title"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
