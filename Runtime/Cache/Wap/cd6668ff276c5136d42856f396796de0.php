...
<div>
      <div class="news_list" id="news-list"> 
        ...
        <ul id="listtable" class="news-lists">
		 ...
		 <?php $_list=getItems(427,'8',0);if(!empty($_list)){foreach($_list as $k=>$item){?><li class="ali"> <a class="ui-link" target="_blank" href="<?php echo ($item["url"]); ?>">
            <h3> <cite></cite><span style="color:"><?php echo ($item["title"]); ?></span></h3>
            <p><?php echo ($item["dateline"]); ?></p>
			</a></li><?php }}?>
        </ul>
		
		<ul id="listtable" class="news-lists exhibit-lists">
          
		  <?php $_list=getItems(429,'8',0);if(!empty($_list)){foreach($_list as $k=>$item){?><li class="ali"> <a class="ui-link" target="_blank" href="<?php echo ($item["url"]); ?>">
            <h3> <cite></cite> <img src="<?php echo ($item["pic"]); ?>"> <span style="color:"><?php echo ($item["title"]); ?></span></h3>
            </a> </li><?php }}?>
        </ul>
