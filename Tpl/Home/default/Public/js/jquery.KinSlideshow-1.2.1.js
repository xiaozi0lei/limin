...
$.fn.KinSlideshow = function(settings){
	 ...
	 function KSS_setTitleBar(){
		...
		$(ksbs+" .KSS_titleBar").css({height:getTitleBar_Height,width:KSS_Size[0],position:"absolute",bottom:11,left:15})
			$("#banner img").css({ width:KSS_Size[0]});
	 ...
	 function KSS_setTitleFont(){
		 if(settings.isHasTitleFont){
			...
			$(ksbs+" .KSS_titleBox").css({height:getTitleBar_Height,width:KSS_Size[0],position:"absolute",bottom:11,left:0})
