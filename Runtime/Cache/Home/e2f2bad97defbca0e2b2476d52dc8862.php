...
<div class="nyban"><img src="../Public/images/1.jpg"></div>
<div class="main">
<div class="gao"></div>
...
<div id="page_main" class="clearfix">
 <div class="container">
  ...
  <div class="lanmu">
          <div class="lmdh fl"><?php echo ($current_sort['name']); ?></div>
   ...
   <div class="page-products">
     <ul class="clearfix product-nav" id="ShowImages">
	   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($item["url"]); ?>" title="<?php echo ($item["title"]); ?>"><span><img src="<?php echo ($site_url); ?>/<?php echo ($item["pic"]); ?>" alt="<?php echo ($item["title"]); ?>" width="178" height="150" /><img class="imghou" src="../Public/images/tupxg.png" width="178" height="150" /></span><p><?php echo ($item["title"]); ?></p></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
<!--	    <script>
$(function(){
	$(".product-nav li").hover(function(){
		$(this).find("img:last").stop().slideDown(200)
		},function(){
		$(this).find("img:last").stop().slideUp(200)	
			})
	})
</script>-->
	 </ul>
